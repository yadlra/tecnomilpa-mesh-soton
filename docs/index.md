...
#### [The Site Planner walkthrough](site-planner.md)
How we used the Meshtastic Site Planner (site.meshtastic.org) to predict coverage from October Books before the walk. Includes the actual coverage map and the exact parameters used.
</div>

<div class="card" markdown>
#### [The survey sheet](survey-sheet.md)
The printable A4 form students fill in at each candidate site. Five observational blocks per site, plus a sketch box. Downloadable as Word and PDF.
</div>

<div class="card" markdown>
#### [What we found on the walk](findings.md)
The findings page, to be written after the walk on Thursday 14 May 2026.
</div>
